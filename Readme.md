...
# Configuration Script – TTNGWMON - Rev. A

This **Configuration** script is designed for the **TTNGWMON** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – TTNGWMON Rev. A

Este script de **Configuration** está diseñado para el modelo **TTNGWMON** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
